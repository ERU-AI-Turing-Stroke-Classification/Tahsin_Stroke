...
train_dataset = ImageFolder(root="/content/drive/MyDrive/stroke/inme/son_veriler/train", transform=transform)
val_dataset = ImageFolder(root="/content/drive/MyDrive/stroke/inme/son_veriler/validation", transform=transform)
test_dataset = ImageFolder(root="/content/drive/MyDrive/stroke/inme/son_veriler/test", transform=transform)
...
for epoch in range(start_epoch, epochs):
    ...
    if val_accuracy > best_accuracy:
        best_accuracy = val_accuracy  # Güncellendi!
        torch.save({
            'model_state_dict': model.state_dict(),
            'best_accuracy': best_accuracy
        }, best_model_path)
