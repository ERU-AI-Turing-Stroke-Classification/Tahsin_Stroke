...
# **VGG19 Modelini Yükle ve Özelleştir (Dropout Eklenmiş)**
model = models.vgg19(weights=VGG19_Weights.IMAGENET1K_V1)

# **Classifier kısmını Dropout ekleyerek değiştir**
model.classifier = nn.Sequential(
    nn.Linear(25088, 4096),
    nn.ReLU(),
    nn.Dropout(0.5),  # Dropout eklendi (%50)
    nn.Linear(4096, 512),
    nn.ReLU(),
    nn.Dropout(0.5),  # Dropout eklendi (%50)
    nn.Linear(512, 1)
...
checkpoint_path = "/content/drive/MyDrive/VGG19_2/model_checkpoint.pth"
best_model_path = "/content/drive/MyDrive/VGG19_2/best_model.pth"
