...
checkpoint_last = "/content/drive/MyDrive/ResNet50CbamGausF1/checkpoint_last.pth"
checkpoint_best = "/content/drive/MyDrive/ResNet50CbamGausF1/best_model.pth"
...
for epoch in range(start_epoch, num_epochs):
    ...
    print(f"Epoch {epoch+1}: Train Loss: {train_loss/len(train_loader):.4f}, Accuracy: {train_acc:.2f}%, F1 Score: {train_f1:.4f}")
    ...
    print(f"Epoch {epoch+1}: Validation Loss: {val_loss/len(val_loader):.4f}, Validation Accuracy: {val_acc:.2f}%, Validation F1 Score: {val_f1:.4f}")
